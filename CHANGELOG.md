...
- `MutableVecExt::signal_vec_filter_map*` functions added

## [0.13.0,1] - 2026-03-14

### Changed

- `MutableVecExt::set_if*` functions added
...
- `MutableVecExt::replace_keyed` optimized
...
- `SignalVecFinalizerExt::any_item` added

## [0.10.2, 0.10.3] - 2026-01-01

### Added

- `MutableOption::inspect` and `MutableOption::inspect_mut` added
